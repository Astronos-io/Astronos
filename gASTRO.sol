...
contract gASTRO is IgASTRO, ERC20 {
    ...
    constructor(address _migrator, address _sASTRO)
        ERC20("Governance ASTRO", "gASTRO", 18)
    {
     ...
     * @param _sASTRO address
     */
    function migrate(address _staking, address _sASTRO) external override onlyApproved {
        ...
        require(_sASTRO != address(0), "Zero address found");
        sASTRO = IsASTRO(_sASTRO);
    }
    ...
    /**
     * @notice pull index from sASTRO token
     */
    ...
    /**
        @notice converts gASTRO amount to ASTRO
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts ASTRO amount to gASTRO
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gASTRO::getPriorVotes: not yet determined");
